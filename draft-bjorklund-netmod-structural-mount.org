...
!! include-figure ietf-yang-structural-mount.yang extract-to="ietf-yang-structural-mount@2016-02-25.yang"
...
Structural mount is used to mount the data models each device supports.
...
This section lists open issues that should be discsussed before this
document is published.

- required-packages
- support non-named mount points? (ysdl case)
